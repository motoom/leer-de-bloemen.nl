...
itembanks = (
    ("Wellknown flowers",
        easy,
        "<p>We start with some well known flowers, to get your feet wet!</p><p>It's OK when you guess a flower wrong, I'll just show you the right answer.</p><p>Go ahead!</p>",
